...
def open_add_new_record_window() :
    ...
    labelframe_input_details_lab4 = Label(add_new_record_window, text = "Course : ", font = ("Aerial", 25))
...
def open_update_record_window() :
    ...
    label_frame2_lab2 = Label(update_record_window, text = "New Course: ", font = ("Aerial", 25))
...
def open_delete_record_window() :
    ...
    labelframe_search_record_lab4 = Label(delete_record_window, text = "Course : ", font = ("Aerial", 25))
